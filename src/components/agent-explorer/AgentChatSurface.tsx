...
import { Check, Loader2, MessageSquare, Pencil, Plus, Send, X } from "lucide-react";
...
export function AgentChatSurface({ controller }: { controller: AgentExplorerController }) {
  ...
  // which beats the raw timestamp/id/turns label — see the session helpers.
      ...
      <div className="px-6 py-3 border-t border-border bg-muted/20 flex flex-col gap-2">
        <div className="flex flex-row gap-2">
          <Input
            ...
            // disabled:opacity-100: the placeholder carries the reason it's
            // disabled (e.g. "SUSPENDED — cannot send") — Input's default
            // disabled:opacity-50 would fade that out further on top of the
            // already-dim SUGGESTION_PLACEHOLDER_CLASS right when it matters.
