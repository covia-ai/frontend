    ...
    <div data-testid="chat-container" className="flex flex-col items-center justify-center py-10 px-10 ">
        ...
        <div className="flex flex-col md:flex-row lg:flex-row items-center justify-center w-full space-x-2 space-y-2 ">
          ...
          <Dialog >         
           ...
           {key != '' && <Button  aria-label="Run" role="button" data-testid="chat-button" variant="default" className="my-4 btn btn-xs mx-0 bg-primary dark:bg-primary-light text-primary-foreground"><MagicWandIcon/></Button>}
           {key == '' && <Button  aria-label="Run" role="button" disabled data-testid="chat-button" variant="default" className="my-4 btn btn-xs mx-0 bg-primary dark:bg-primary-light text-primary-foreground "><MagicWandIcon/></Button>}
</div>
        </div>
