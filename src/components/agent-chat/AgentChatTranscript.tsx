...
export function AgentChatTranscript({
  ...
  return (
    <div
      ref={transcriptRef}
      data-testid="clean-agent-transcript"
          ...
          groupTranscript(session.conversation).map((item) => {
            ...
            return isUser ? (
              <div className="mb-6 flex justify-end" key={index}>
                <div className="max-w-[85%] rounded-3xl rounded-br-md bg-muted px-4 py-2.5 text-sm leading-6 whitespace-pre-wrap break-words">
              ...
              <div className="mb-8 flex gap-3" key={index}>
                ...
                <div className="min-w-0 flex-1 whitespace-pre-wrap break-words text-sm leading-7">
                  {text}
                </div>
              </div>
            );
